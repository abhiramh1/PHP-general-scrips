...
<form style="text-align:center" action="edit.php" method="post">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="aname"  value="<?php echo $row["aname"];?>">
              </div>
              <div class="form-group">
                <label > Attendees' Time: </label>
                <input type="text" class="form-control" name="atime"  value="<?php echo $row["atime"];?>">
              </div>
